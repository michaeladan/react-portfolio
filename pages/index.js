      ...
      <main className=' bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
        ...
        <section>
          <div>
            ...
            <p className='text-md py-2 leading-8 text-gray-800 dark:text-gray-100'>
              Is there a website you have been <span className='text-teal-500'>dreaming</span> of making? 
              Or maybe you have work you would like to share and have it availabe online. 
              Share your ideas with me and I can bring them to life on the <span className='text-teal-500'>world wide web</span>.
            </p>
          </div>
